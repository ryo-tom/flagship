...
class CustomerControllerTest extends TestCase
{
    ...
    |--------------------------------------------------------------------------
    */
    public function test_認証済みユーザーは取引先作成フォームを閲覧できる(): void
    {
        $this->actingAs($this->user);
    ...
    public function test_未認証ユーザーは取引先作成フォームを閲覧できない(): void
    {
        $response = $this->get(route('customers.create'));
    ...
    |--------------------------------------------------------------------------
    */
    public function test_認証済みユーザーは取引先の新規登録ができる(): void
    {
        $this->actingAs($this->user);
    ...
    */
    ...
    public function test_認証済みユーザーは連絡先を持たない取引先を削除できる(): void
    {
        $this->actingAs($this->user);
